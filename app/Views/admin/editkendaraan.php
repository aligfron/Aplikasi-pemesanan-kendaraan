            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <!-- Content Column isi -->
                        <form name="twisata" method="POST" action="/menuadmin/update/<?= $kendaraan['id_kendaraan']; ?>">
                <table class="table">
                    <tr>
                        <td>Nama Kendaraan</td>
                        <td>&nbsp;:&nbsp;</td>
                        <td><input type="text" name="nama" class="form-control" required autocomplete="off" autofocus value="<?= $kendaraan['nama_kendaraan']; ?>"></td>
                    </tr>
                    <tr>
                        <td>Nomor Plat</td>
                        <td>&nbsp;:&nbsp;</td>
                        <td><input type="text" name="no" class="form-control" required autocomplete="off" value="<?= $kendaraan['no_plat']; ?>"></td>
                    </tr>
                    <tr>
                        <td>Jenis Kendaraan</td>
                        <td>&nbsp;:&nbsp;</td>
                        <td><input type="text" name="jenis" class="form-control" required autocomplete="off" value="<?= $kendaraan['jenis_kendaraan']; ?>">
                        </td>
                    </tr>
             <tr>
