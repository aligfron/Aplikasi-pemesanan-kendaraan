            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <!-- Content Column isi -->
                        <form name="twisata" method="POST" action="/menuadmin/prosestambah">
                <table class="table">
                    <tr>
                        <td>Nama Kendaraan</td>
                        <td>&nbsp;:&nbsp;</td>
                        <td><input type="text" name="nama" class="form-control" required autocomplete="off" autofocus ></td>
                    </tr>
                    <tr>
                        <td>Nomor Plat</td>
                        <td>&nbsp;:&nbsp;</td>
                        <td><input type="text" name="no" class="form-control" required autocomplete="off" ></td>
                    </tr>
                    <tr>
                        <td>Jenis Kendaraan</td>
                        <td>&nbsp;:&nbsp;</td>
                        <td><input type="text" name="jenis" class="form-control" required autocomplete="off" >
                        </td>
                    </tr>
             <tr>
                        <td colspan="3"><input type="submit" name="tbh" Value="Tambah" class="btn btn-success"></td>
                    </tr>
                </table>
            </form>
                    </div>
